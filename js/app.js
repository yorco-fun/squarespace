(() => {
    ...
    function initSliders() {
        if (document.querySelector(".sites__slider")) new swiper_core_Swiper(".sites__slider", {
        ...
        if (document.querySelector(".starting-point__slider")) new swiper_core_Swiper(".starting-point__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            pagination: {
                el: ".starting-point__pagination",
                clickable: true,
                type: "fraction"
            },
            navigation: {
                prevEl: ".starting-point__arrow--left",
                nextEl: ".starting-point__arrow--right"
            },
            breakpoints: {
                640: {
                    slidesPerView: 1,
